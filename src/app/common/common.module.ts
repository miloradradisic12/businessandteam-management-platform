...
import { TradeCompletedTransactionsComponent } from './wallet/trade-history/trade-completed-transactions/trade-completed-transactions.component';
...
@NgModule({
  ...
  declarations: [EmployeeRatingComponent, TaskAttributesComponent, WalletComponent, BankAccountComponent, TransactionsComponent, TradeHistoryComponent, PendingTransactionsComponent, CompletedTransactionsComponent, TradePendingTransactionsComponent, TradeCompletedTransactionsComponent, FundingDetailsComponent, DepositWithdrawFundComponent],

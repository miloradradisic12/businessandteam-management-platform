...
export class FounderProjectDetailsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.buttons = [
      {caption: 'Operations', color: '#00D8C9', icon: 'operations.png', link: 'operations'},
      {caption: 'Workflow', color: '#FE5F5B', icon: 'workflow.png', link: 'processesdue-soon'},
      {caption: 'Tasks', color: '#679BF9', icon: 'tasks.png', link: 'task'},
      {caption: 'Budget', color: '#FF6C24', icon: 'budget.png', link: 'budget'},
      {caption: 'Recruitment', color: '#00D8C9', icon: 'recruitment.png',link: 'recruitment'},
      {caption: 'Messages', color: '#679BF9', icon: 'messages.png', link: 'collaboration'}
    ];
  }

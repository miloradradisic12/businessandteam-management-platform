...
@Component({
    selector:'app-founder-crowd-equity',
    templateUrl:'./crowd-equity.component.html',
    styleUrls:['../funding-type.component.scss']
})
export class FounderProjectCrowdEquityFunding implements OnInit{
    ...
    ngOnInit(){
        ...
        this.amount_equity= new FormControl({value:'', disabled: this.showReadOnly}, [Validators.required, CustomValidators.numeric]);
        ...
        this.frmFundDetails = this.fb.group({
            ...
            due_by: this.due_by,
            amount_equity: this.amount_equity,

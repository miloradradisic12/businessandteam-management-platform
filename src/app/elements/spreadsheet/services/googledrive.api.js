...
(function () {
  ...
  var ca = -1 != n.indexOf("Opera"),
    ...
    ea = -1 != n
      .toLowerCase()
      .indexOf("webkit") && -1 == n.indexOf("Edge"),
    y = function () {
      var a = k.document;
      return a
        ? a.documentMode
          ...
          do 
            {
              h = /(\d*)(\D*)(.*)/.exec(h) || ["", "", "", ""];
            g = /(\d*)(\D*)(.*)/.exec(g) || ["", "", "", ""];
            if (0 == h[0].length && 0 == g[0].length) 
              break;
            b = m(0 == h[1].length
              ? 0
              : parseInt(h[1], 10), 0 == g[1].length
              ? 0
              : parseInt(g[1], 10)) || m(0 == h[2].length, 0 == g[2].length) || m(h[2], g[2]);
            h = h[3];
            g = g[3]
          } while (0 == b)
        }
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  ...
  var U = function (a, b, c) {
    ...
    V = function (a, b, c) {
      b && 0 < b.length && (b = ra(b), c && 0 < c.length && (b += "___" + ra(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = M(pa, "_p", N()), M(b, c, N())[a] = (new Date).getTime(),
      U(a, "_p", c))
    },
    ra = function (a) {
      return a
  ...
  var Z = decodeURI("%73cript"),
    ...
    Ia = function () {
      var a = P.nonce;
      if (void 0 !== a) 
        return a && a === String(a) && a.match(Ga)
          ? a
          : P.nonce = null;
      var b = M(P, "us", []);
      if (!b || !b.length) 
      ...
      for (var c = L.getElementsByTagName(Z), d = 0, e = c.length; d < e; ++d) {
        ...
        if (f.src && (a = String(f.nonce || f.getAttribute("nonce") || "") || null)) {
          ...
          ;
          if (h !== g && a && a === String(a) && a.match(Ga)) 
            return P.nonce = a
        }
      }
      return null
...
gapi.load("client", {
  ...
  _c: {
    "jsl": {
      "ci": {
        ...
        "iframes": {
          ...
          "plus_share": {
            ...
            "url": ":socialhost:/:session_prefix::se:_/+1/sharebutton?plusShare\u003dtrue\u0026usega" +
                "pi\u003d1"
          },
          ":source:": "3p",
          "playemm": {
          ...
          "dataconnector": {
            "url": "https://dataconnector.corp.google.com/:session_prefix:ui/widgetview?usegapi" +
                "d1"
          },
          "shortlists": {
            "url": ""
          ...
          "community": {
            "url": ":ctx_socialhost:/:session_prefix::im_prefix:_/widget/render/community?usegapi" +
                "03d1"
          },
          "plus": {
      ...
      "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.wekA59kPUjU.O/m\u003d__features__/am" +
          "\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCOacrwW3spyEgPbbz9Wh2MPXqdCDA",
      "u": "https://apis.google.com/js/client.js?onload\u003dinitPicker",
      "hee": true,
      "fp": "91eeff42a0cbcb3f698246ba1f9c44b53c120333",
      "dpo": false
    },
    "fp": "91eeff42a0cbcb3f698246ba1f9c44b53c120333",
    "annotation": [
      "interactivepost", "recobar", "signin2", "autocomplete", "profile"
    ],

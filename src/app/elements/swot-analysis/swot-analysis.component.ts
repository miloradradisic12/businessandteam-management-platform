...
export class SwotAnalysisComponent implements ControlValueAccessor, OnInit {

  @Input() isSummary = false;

  edit_btn_class = 'edit-svg-btn';
  addstrength: boolean = false;
  addweakness: boolean = false;
  addopportunity: boolean = false;
  addthreats: boolean = false;
  editstrength: boolean = false;
  editweakness: boolean = false;
  editopportunity: boolean = false;
  editthreats: boolean = false;

  swot: { 'strength': string[], 'weakness': string[], 'opportunity': string[], 'threat': string[] } = { 'strength': [], 'weakness': [], 'opportunity': [], 'threat': [] };
